...
// Ajuste: Caminhos relativos explÃ­citos baseados na estrutura app/ vs src/
...
export default function NovoCliente() {
  ...
  const handleSalvar = async () => {
    ...
    try {
      ...
      // 2. Inserir VeÃ­culo (se preenchido)
    ...
    <div className="max-w-4xl mx-auto space-y-6 pb-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1">
            ...
            <input
              ...
              placeholder={tipoPessoa === 'pf' ? "Ex: JoÃ£o da Silva" : "Ex: Transportadora Veloz Ltda"}
      ...
      <div className="bg-white rounded-[32px] p-6 shadow-sm border border-stone-100 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="space-y-1">
            <label className="text-xs font-bold text-stone-400 ml-2">NÃMERO</label>
      ...
      <div className="bg-white rounded-[32px] p-6 shadow-sm border border-stone-100 transition-all">
        ...
        {!addCarro ? (
          ...
          >
            <Plus size={20} /> Cadastrar um veÃ­culo agora?
          </button>
        ) : (
          <div className="space-y-4 animate-in slide-in-from-top-2">
            <div className="flex justify-between items-center">
              <h3 className="font-bold text-[#1A1A1A] flex items-center gap-2">
                <Car size={18} /> VeÃ­culo Principal
              </h3>
