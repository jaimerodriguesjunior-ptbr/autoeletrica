      ...
      <div className="bg-white rounded-[32px] p-6 shadow-sm border border-stone-100 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="space-y-1">
            ...
            <input type="text" value={cep} onChange={e => setCep(e.target.value)} placeholder="00000-000" className="w-full bg-[#F8F7F2] rounded-2xl p-4 font-medium text-[#1A1A1A] outline-none focus:ring-2 focus:ring-[#FACC15] transition" />
          </div>
          <div className="md:col-span-2 space-y-1">
            <label className="text-xs font-bold text-stone-400 ml-2">RUA / AVENIDA</label>
            <input type="text" value={rua} onChange={e => setRua(e.target.value)} placeholder="Av. Brasil" className="w-full bg-[#F8F7F2] rounded-2xl p-4 font-medium text-[#1A1A1A] outline-none focus:ring-2 focus:ring-[#FACC15] transition" />
          </div>
          <div className="space-y-1">
            <label className="text-xs font-bold text-stone-400 ml-2">NÚMERO</label>
            <input type="text" value={numero} onChange={e => setNumero(e.target.value)} placeholder="123" className="w-full bg-[#F8F7F2] rounded-2xl p-4 font-medium text-[#1A1A1A] outline-none focus:ring-2 focus:ring-[#FACC15] transition" />
          </div>
          <div className="md:col-span-2 space-y-1">
            <label className="text-xs font-bold text-stone-400 ml-2">BAIRRO</label>
            <input type="text" value={bairro} onChange={e => setBairro(e.target.value)} placeholder="Centro" className="w-full bg-[#F8F7F2] rounded-2xl p-4 font-medium text-[#1A1A1A] outline-none focus:ring-2 focus:ring-[#FACC15] transition" />
          </div>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <input 
                  ...
                  className="w-full bg-[#F8F7F2] rounded-2xl p-4 font-bold text-[#1A1A1A] outline-none focus:ring-2 focus:ring-[#FACC15] uppercase" 
                />
              </div>
              <div className="space-y-1">
