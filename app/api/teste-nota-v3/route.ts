    ...
    try {
        ...
        const payload = {
            ...
            "infDPS": {
                ...
                "prest": {
                    "CNPJ": "35181069000143" // CNPJ correto
                },
                "toma": {
        ...
        console.log("Enviando DPS de teste v3:", JSON.stringify(payload, null, 2));

        // Debug: Write payload to file using absolute path
        const debugPath = path.join(process.cwd(), 'debug_payload_v3.json');
        ...
        console.log("Resposta DPS v3:", JSON.stringify(result, null, 2));

        const debugResponsePath = path.join(process.cwd(), 'debug_response_v3.json');
        ...
        console.error("Erro no teste v3:", error);
