                ...
                <div className="flex bg-stone-50 p-1 rounded-2xl overflow-x-auto scrollbar-hide">
                    {["todos", "em andamento", "orçamentos", "finalizados"].map((tab) => (
                        <button
                            ...
                            className={`px-4 py-2 rounded-xl text-xs font-bold capitalize whitespace-nowrap transition ${filtroAtivo === tab ? "bg-white text-[#1A1A1A] shadow-sm" : "text-stone-400 hover:text-stone-600"}`}
                        >
                            {tab}
                        </button>
                    ))}
